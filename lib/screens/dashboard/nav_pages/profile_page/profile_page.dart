          ...
          if (state is ProfileErrorState) {
            return Center(
                child: SizedBox(
                    width: 250,
                    height: 250,
                    child: Lottie.asset("assets/lottie/network_problem.json",
                        fit: BoxFit.cover)));
          }
                  ...
                  children: [
                        ...
                        children: [
                          StatefulBuilder(
                            builder: (_, ss) {
                              return InkWell(
                                onTap: () async {
                                  XFile? imgPicked = await ImagePicker()
                                      .pickImage(source: ImageSource.gallery);
                                  if (imgPicked != null) {
                                    CroppedFile? imgCropped =
                    ...
                    ListView(
                      ...
                      children: [
                        ...
                        InkWell(
                            onTap: () {
                              Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) => PlaceOdersPage(),
                                  ));
                            },
                            child: myListTile(
                        ...
                        myListTile(
                            icon: Icons.email,
                            title: state.mData.data!.email.toString(),
                            isDark: isDark),
                        myListTile(
                            icon: Icons.phone,
                            title: state.mData.data!.mobileNumber.toString(),
                            isDark: isDark),
                        myListTile(
                            icon: Icons.lock,
                            title: state.mData.data!.password.toString(),
                            isDark: isDark),
                        Text(
                          "Account Details",
                          style: mytext13(
                        ...
                        myListTile(
                            ...
                            title: state.mData.data!.createdAt.toString(),
                            isDark: isDark),
                        myListTile(
                              ...
                              showDialog(
                                  ...
                                  builder: (context) {
                                    return AlertDialog.adaptive(
                                      ...
                                      content: Text(
                                        "Your all preferences will be cleared !!",
                                      ),
                                      icon: Icon(
                                        Icons.logout,
                                        size: 30,
                                          ...
                                          children: [
                                            OutlinedButton(
                                                onPressed: () async {
                                                  ...
                                                  await pref.setString(AppConstData.PREF_UID, "");
